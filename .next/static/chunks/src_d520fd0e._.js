...
function GameWorld({ onMove }) {
    ...
    const [selectedTool, setSelectedTool] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('none');
        ...
        "GameWorld.useEffect": ()=>{
            ...
            const render = {
                "GameWorld.useEffect.render": ()=>{
                    ...
                    ctx.fill();
                    // Draw player name and selected tool
                    ctx.fillStyle = '#FFFFFF';
                    ctx.font = 'bold 16px Arial';
                    ctx.textAlign = 'center';
                    ctx.fillText('Player', playerPos.x, playerPos.y - 30);
                    if (selectedTool !== 'none') {
                        ctx.fillText(selectedTool, playerPos.x, playerPos.y - 50);
                    }
                    // Request next frame
...
_s(GameWorld, "zfRUfi1QWmYfDhh0cyTGwCyjugU=", false, function() {
    return [
        useGame
    ];
});
...
function EasterValley() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(GameProvider, {
...
//# sourceMappingURL=src_d520fd0e._.js.map